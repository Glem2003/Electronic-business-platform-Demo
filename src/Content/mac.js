        ...
        section_info: [
            {
                title: "來了解 Mac。",
                info_item: [
                    { title: "輕鬆啟用", subtitle: "容易用，容易愛上。", src: "/images/mac/mac_ease__bvgkz2zdltxy_medium.jpg" },
                    { title: "效能表現與電池續航", subtitle: "速度快，持續耐久", src: "/images/mac/mac_performance__dh5hyac1zf8m_medium.jpg" },
                    { title: "Mac 與 iPhone", subtitle: "夢幻組合", src: "/images/mac/mac_iphone__gh1tblkt6bqm_medium.jpg" },
                    { title: "相容性", subtitle: (<>Mac 可執行<br />你常用的 App。</>), src: "/images/mac/mac_compatibility__cu59oukz81ci_medium.jpg" },
                    { title: "隱私權與安全保護", subtitle: (<>你的私事，<br />誰都無權知道。</>), src: "/images/mac/mac_security__gfwda10khdym_xlarge.jpg" },
                    { title: "經久耐用", subtitle: (<>精心打造<br />經得起時間考驗。</>), src: "/images/mac/mac_durability__epiwcuk7zkeq_xlarge.jpg" },
                    { title: "Apple 價值理念", subtitle: (<>我們做的每件事<br />都體現我們的價值理念。</>), src: "/images/mac_values__c9gck9qi4kia_xlarge.jpg" },
                ]
            }
        ],
        section_3: [
                ...
                product_info_item: [
                    {
                        laptops: [
                            {
                                src: "/images/mac/product_tile_mba_13_15__fx2g3qlubdym_medium_2x.png",
                                alt: "MacBook Air",
                                color: ["white", "black"],
                                postscript: "全新 M3 機型",
                                ...
                                productInfoItem:
                                    [
                                        { text: "Apple M2 或 M3 晶片", src: "/images/mac/product_tile_icon_m2_m3__jo6w8mbgmmye_large_2x.png" },
                            ...
                            {
                                src: "/images/mac/product_tile_mbp_14_16__bkl8zusnkpw2_medium_2x.png",
                                alt: "MacBook Pro",
                                ...
                                productInfoItem:
                                    [
                                        { text: "Apple M3、M3 Pro 或 M3 Max 晶片", src: "/images/mac/product_tile_icon_m3_pro_max__wg8d2vblzmqi_large_2x.png" },
                        ...
                        desktops: [
                            {
                                src: "/images/mac/product_tile_imac_24__inq0od011wuq_medium_2x.png",
                                alt: "iMac",
                                color: ["white", "black"],
                                title: "iMac",
                                subtitle: "M3 晶片",
                                ...
                                productInfoItem:
                                    [
                                        ...
                                        { text: "Apple M3 晶片", src: "/images/mac/product_tile_icon_m3__geq4mv9q8qeu_large_2x.png" },
                                        { text: (<><span>-</span></>) },
                                        { text: (<><h4>最多可達</h4><h1>6 個連接埠</h1><h4>2 個 Thunderbolt / USB 4、最多可達 2 個 USB 3、<br />Gigabit 乙太網路、耳機插孔</h4></>) },
                                    ]
                            },
                            {
                                src: "/images/mac/product_tile_mac_mini__c4284n3j25w2_medium_2x.png",
                                alt: "Mac mini",
                                title: "Mac mini",
                                ...
                                productInfoItem:
                                    [
                                        { text: (<><span>-</span></>) },
                                        { text: "Apple M2 或 M2 Pro 晶片", src: "/images/mac/product_tile_icon_m2_pro__c5ftjeskmwuq_large_2x.png" },
                                        { text: (<><span>-</span></>) },
                                        { text: (<><h4>最多可達</h4><h1>9 個連接埠</h1><h4>最多可達 4 個 Thunderbolt 4、2 個 USB‑A、HDMI、Gigabit 乙太<br />網路、耳機插孔</h4></>) },
                                    ]
                            },
                            {
                                src: "/images/mac/product_tile_mac_studio__c24lhkuq4vee_large_2x.png",
                                alt: "Mac Studio",
                                title: "Mac Studio",
                                ...
                                productInfoItem:
                                    [
                                        { text: (<><span>-</span></>) },
                                        { text: "Apple M2 Max 或 M2 Ultra 晶片", src: "/images/mac/product_tile_icon_m2_max_m2_ultra__d0wnaf44m6qa_large_2x.png" },
                                        { text: (<><span>-</span></>) },
                                        { text: (<><h1>12 個連接埠</h1><h4>最多可達 6 個 Thunderbolt 4、2 個 USB‑A、最多可達 2 個<br />USB‑C、HDMI、10Gb 乙太網路、SDXC、耳機插孔</h4></>) },
                                    ]
                            },
                            {
                                src: "/images/mac/product_tile_mac_pro__6q3qt8073f6e_large_2x.png",
                                alt: "Mac Pro",
                                title: "Mac Pro",
                                ...
                                productInfoItem:
                                    [
                                        { text: (<><span>-</span></>) },
                                        { text: "Apple M2 Ultra 晶片", src: "/images/mac/product_tile_icon_m2_ultra__4mmsok50gvmu_large_2x.png" },
                        ...
                        displays: [
                            {
                                src: "/images/mac/product_tile_studio_display__c0gbtkgtsx0m_large_2x.png",
                                alt: "Studio Display",
                                ...
                                productInfoItem:
                                    [
                                        ...
                                        { text: "1200 萬像素超廣角相機具備人物居中功能，帶來更自然的視訊通話", src: "/images/mac/product_tile_icon_video__br4ndidbu11e_large_2x.png" },
                                        { text: (<>原彩顯示、抗反射鍍膜，並可選配 Nano-texture 玻璃，在任何光線下<br />都能享有最佳的觀賞體驗</>), src: "/images/mac/product_tile_icon_screen__gfttd7yxs9ay_large_2x.png" },
                                        { text: (<><h1>4 個連接埠</h1>Thunderbolt 3 (USB‑C)、3 個 USB‑C</>), src: "/images/mac/product_tile_icon_screen__gfttd7yxs9ay_large_2x.png" },
                                    ]
                            },
                            {
                                src: "/images/mac/product_tile_pro_display__duklzyfwl92e_large_2x.png",
                                alt: "Pro Display XDR",
                ...
                list_item:[
                    {
                        ...
                        text:"探索鍵盤、滑鼠與其他必備配件。",
                        link:"選購 Mac 配件",
                        src:"/images/mac/essentials_accessories__dglhsic54owi_large_2x.jpg"
                    },
                    {
                        title:"Studio Display",
                        text:"27 吋 5K Retina 顯示器，可與任何 Mac 聯手漂亮出擊。",
                        link:"進一步了解",
                        src:"/images/mac/essentials_display__bk3i351qm0c2_large_2x.jpg"
                    }
                ]
            }
        ],
